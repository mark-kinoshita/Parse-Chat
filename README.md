...
- [ ] List anything else that you can get done to improve the app functionality! (+1-3pts)
 - [x] Logout button to return to first viewcontroller(LoginViewController)

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. Setting up profiles for users
2. Using firebase to achieve the same results

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/1Ykgk1B.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
